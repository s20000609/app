...
pub use commands::{
    ...
    __cmd__chat_continue, __cmd__chat_generate_scene_image, __cmd__chat_generate_user_reply,
    __cmd__chat_regenerate, __cmd__chat_template_export_as_usc, __cmd__create_prompt_template,
    ...
    __cmd__reset_scene_generation_template, __cmd__retry_dynamic_memory, __cmd__search_messages,
    ...
    chat_completion, chat_continue, chat_generate_scene_image, chat_generate_user_reply,
