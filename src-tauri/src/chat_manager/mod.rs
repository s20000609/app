...
pub use commands::{
    ...
    chat_continue, chat_generate_user_reply, chat_regenerate, chat_template_export_as_usc,
    create_prompt_template, delete_prompt_template, export_prompt_template_as_usc,
